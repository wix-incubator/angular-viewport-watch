...
Boost performance of [Angular](http://www.angularjs.org) `ng-repeat` directive for long lists by disabling watcher while elements are not displayed inside viewport
